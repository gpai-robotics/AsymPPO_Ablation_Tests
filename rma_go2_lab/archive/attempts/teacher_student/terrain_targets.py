"""Pure tensor terrain targets for teacher-side supervision.

This module intentionally has no IsaacLab environment/config imports so it can
be safely imported by training-time PPO code before the full simulator stack is
ready.
"""

...
class AdaptationPPOWithV3Expert(PPO):
    ...
    def update(self) -> dict[str, float]:
        ...
        for (
            ...
            if self.v3_expert is not None and imitation_coef > 0.0:
                ...
                if mask is not None and required_groups.issubset(set(expert_obs_batch.keys())):

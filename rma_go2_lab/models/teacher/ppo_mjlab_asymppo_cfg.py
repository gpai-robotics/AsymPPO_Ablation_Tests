...
from rma_go2_lab.models.asymppo.history_actor_critic import TemporalBlindActorCritic
from rma_go2_lab.models.asymppo.policy_cfg import AsymPpoHistoryPolicyCfg
...
class Go2BlindRoughMjlabAsymPpoRunnerCfg(RslRlOnPolicyRunnerCfg):
    ...
    policy = AsymPpoHistoryPolicyCfg(
        ...
        activation="elu",
        actor_init_path=MJLAB_FLAT_PRIOR_CKPT if Path(MJLAB_FLAT_PRIOR_CKPT).exists() else None,
...
Go2RoughMjlabTeacherPPORunnerCfg = Go2BlindRoughMjlabAsymPpoRunnerCfg

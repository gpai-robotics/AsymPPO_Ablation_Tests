...
from rma_go2_lab.models.blind.variants_ppo_cfg import (
    BlindWarmStartPolicyCfg,
    Go2BlindBaselineWarmStartPPORunnerCfg,
)


@configclass
class Go2AdaptationStudentNoAdaptPPORunnerCfg(Go2BlindBaselineWarmStartPPORunnerCfg):

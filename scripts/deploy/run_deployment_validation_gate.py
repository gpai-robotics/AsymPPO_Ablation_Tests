...
RUN_MUJOCO_SUITE = REPO_ROOT / "scripts" / "deploy" / "run_mujoco_ood_suite.py"
...
VALIDATE_UNITREE_MJLAB_FSM = REPO_ROOT / "scripts" / "deploy" / "validate_unitree_mjlab_go2_fsm_runtime.py"

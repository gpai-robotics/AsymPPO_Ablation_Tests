...
- task:
  - `RMA-Go2-C1-ETHLike-V2-StageA`
- runner:
  - `rma_go2_lab.models.blind.blind_rough_runner_cfg:Go2C1BlindRoughTeacherHistoryV2PPORunnerCfg`
- policy:
...
- environment config entry point:
  - `rma_go2_lab.envs.blind.c1_blind_rough_teacher_history_cfg:Go2C1BlindRoughTeacherHistoryEnvCfg`
- history/env base:
  - `rma_go2_lab.envs.blind.blind_rough_forward_history_cfg:Go2BlindRoughForwardHistoryEnvCfg`
- runner config entry point:
  - `rma_go2_lab.models.blind.blind_rough_runner_cfg:Go2C1BlindRoughTeacherHistoryV1PPORunnerCfg`
- policy class:
  - `TemporalBlindActorCritic`
...
- env config `Go2C1BlindRoughTeacherHistoryEnvCfg`
- runner config `Go2C1BlindRoughTeacherHistoryV1PPORunnerCfg`
